...
2. What are the key features that currently available scheduling softwares lack that make them undesirable for many of the use cases that professionals require?
3. What are the tasks required in scheduling a meeting by an EIVA?
